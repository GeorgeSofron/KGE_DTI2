...
# Save outputs
# ----------------------------
def save_outputs(output_dir, train_losses, valid_losses, entity2id, relation2id, model: TriModel):
    ...
    ax.set_title("TriModel Training & Validation Loss", fontsize=13, fontweight='bold')
